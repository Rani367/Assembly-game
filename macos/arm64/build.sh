...
echo "Building 2D Platformer for macOS ARM64 (Apple Silicon)..."
...
# Assemble the code
echo "Assembling platformer_macos_arm64.asm..."
nasm -f macho64 platformer_macos_arm64.asm -o platformer_macos_arm64.o
if [ $? -ne 0 ]; then
